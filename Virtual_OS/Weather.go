...
func showWeatherApp(w fyne.Window) {
	...
	res, err := http.Get("https://api.openweathermap.org/data/2.5/weather?q=noida&appid=d8ebaf6142f3daf9ecb1eded890116c6")
	if err != nil {
		fmt.Println(err)
	}
	...
	//w.SetContent(container.NewBorder(panelContent, nil, nil, nil, Weather.Container))
	w.Show()
}
